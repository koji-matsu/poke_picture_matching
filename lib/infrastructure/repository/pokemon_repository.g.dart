...
final class PokemonRepositoryProvider
    extends $NotifierProvider<PokemonRepository, void> {
  ...
  @$internal
  @override
  PokemonRepository create() => PokemonRepository();
...
String _$pokemonRepositoryHash() => r'48355ab35a0d728fb95ec5918acb54e0522475c7';

abstract class _$PokemonRepository extends $Notifier<void> {
  void build();
  @$mustCallSuper
  @override
  void runBuild() {
